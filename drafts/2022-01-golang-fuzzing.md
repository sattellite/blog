...
поведение соответствует ожидаемому поведению создаются тесты [1][1].
...
Существует большое количество видов и методов<sup>[[1]][1]</sup> тестирования,
...
программу и ее функции<sup>[[2]][2]</sup>. В процессе тестирования отслеживается
...
годах. По словам<sup>[[3]][3]</sup> [Джеральда Вайнберга][4] это была
...
Сам термин "fuzz" появился в 1988 году<sup>[[5]][5]</sup>.
...
быстрыми. Они могут дать хороший результат за малую цену<sup>[[14]][14]</sup>.

Фаззинг с учетом покрытия использует результаты прошлых тестов для отслеживания
и последующего увеличения покрытия кода<sup>[[15]][15]</sup>. Такие фаззеры
...
функции принимающие другие типы. Работает только в Linux, но умеет генерировать
архив для [libFuzzer][8].
...
В предстоящем релизе go 1.18 будет добавлен нативный фаззер<sup>[[17]][17]</sup>.
...
считать занчениями по умолчанию<sup>[[18]][18]</sup>. Добавить эти данные можно
